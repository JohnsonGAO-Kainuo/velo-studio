        ...
        >
          <button className="uiverse-download" onClick={() => {
            ...
            const downloadUrl = isAppleSilicon 
              ? 'https://github.com/JohnsonGAO-Kainuo/velo-studio/releases/download/v1.0.0/Openscreen-Mac-arm64-1.0.0-Installer.dmg'
              : 'https://github.com/JohnsonGAO-Kainuo/velo-studio/releases/download/v1.0.0/Openscreen-Mac-x64-1.0.0-Installer.dmg';
