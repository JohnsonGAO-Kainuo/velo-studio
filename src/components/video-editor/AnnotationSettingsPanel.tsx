    ...
    <div className="flex-[2] min-w-0 bg-[#fafafa] border border-neutral-200 rounded-2xl p-4 flex flex-col shadow-xl h-full overflow-y-auto custom-scrollbar">
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm font-medium text-neutral-800">Annotation Settings</span>
        ...
        <Tabs value={annotation.type} onValueChange={(value) => onTypeChange(value as AnnotationType)} className="mb-6">
          ...
          <TabsContent value="text" className="mt-0 space-y-4">
            <div>
              <label className="text-xs font-medium text-neutral-800 mb-2 block">Text Content</label>
              <textarea
                value={annotation.textContent || annotation.content}
                onChange={(e) => onContentChange(e.target.value)}
                placeholder="Enter your text..."
                rows={5}
                className="w-full px-3 py-2 bg-white border border-neutral-200 rounded-lg text-neutral-800 text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#34B27B] focus:border-transparent resize-none"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent className="bg-white border-neutral-200 text-neutral-800 max-h-[200px]">
                      {FONT_SIZES.map((size) => (
              ...
              <div className="flex items-center justify-between gap-2">
                <ToggleGroup type="multiple" className="justify-start bg-white p-1 rounded-lg border border-neutral-200">
                  <ToggleGroupItem 
                    value="bold" 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-medium text-neutral-800 mb-2 block">Text Color</label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button 
                        variant="outline" 
                        className="w-full h-9 justify-start gap-2 bg-white border-neutral-200 hover:bg-neutral-100 px-2"
                      >
                        <div 
                ...
                <div>
                  <label className="text-xs font-medium text-neutral-800 mb-2 block">Background</label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button 
                        variant="outline" 
                      ...
                      >
                        <div 
                          className="w-4 h-4 rounded-full border border-neutral-300 relative overflow-hidden" 
                        >
                    ...
                    <PopoverContent className="w-[260px] p-3 bg-white border border-neutral-200 rounded-xl shadow-xl">
                      ...
                      <Button 
                        variant="ghost" 
                        size="sm" 
                        className="w-full mt-2 text-xs h-7 hover:bg-white text-neutral-500"
                        onClick={() => {
          ...
          <TabsContent value="image" className="mt-0 space-y-4">
            ...
            <Button
              ...
              variant="outline"
              className="w-full gap-2 bg-white text-neutral-800 border-neutral-200 hover:bg-[#34B27B] hover:text-white hover:border-[#34B27B] transition-all py-8"
            >
            ...
            {annotation.content && annotation.content.startsWith('data:image') && (
              <div className="rounded-lg border border-neutral-200 overflow-hidden bg-white p-2">
                <img
          ...
          <TabsContent value="figure" className="mt-0 space-y-4">
            <div>
              <label className="text-xs font-medium text-neutral-800 mb-3 block">Arrow Direction</label>
            ...
            <div>
              <label className="text-xs font-medium text-neutral-800 mb-2 block">Arrow Color</label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button 
                    variant="outline" 
                    className="w-full h-10 justify-start gap-2 bg-white border-neutral-200 hover:bg-neutral-100"
                  >
                    <div 
        ...
        <div className="mt-6 p-3 bg-white rounded-lg border border-neutral-200">
          <div className="flex items-center gap-2 mb-2 text-neutral-700">
            <Info className="w-3.5 h-3.5" />
            <span className="text-xs font-medium">Shortcuts & Tips</span>
          </div>
          <ul className="text-[10px] text-neutral-500 space-y-1.5 list-disc pl-3 leading-relaxed">
            <li>Move playhead to overlapping annotation section and select an item.</li>
            <li>Use <kbd className="px-1 py-0.5 bg-neutral-100 rounded text-neutral-700 font-mono">Tab</kbd> to cycle through overlapping items.</li>
            <li>Use <kbd className="px-1 py-0.5 bg-neutral-100 rounded text-neutral-700 font-mono">Shift+Tab</kbd> to cycle backwards.</li>
          </ul>
        </div>
      </div>
    </div>
