import jt, { ipcMain as Q, screen as ht, BrowserWindow as ot, desktopCapturer as cd, shell as ud, app as me, dialog as Xn, protocol as Ul, nativeImage as kl, net as fd, systemPreferences as ji, Tray as dd, Menu as hd } from "electron";
import { fileURLToPath as Ml, pathToFileURL as pd } from "node:url";
...
import ql from "zlib";
import yd from "http";
const tn = z.dirname(Ml(import.meta.url)), Ed = z.join(tn, ".."), Et = process.env.VITE_DEV_SERVER_URL, ui = z.join(Ed, "dist");
let cr = null;
...
function Td(e, t, r, n, i) {
  Q.handle("get-sources", async (a, s) => (await cd.getSources(s)).map((d) => ({
    id: d.id,
    name: d.name,
    ...
    try {
      return await ud.openExternal(s), { success: !0 };
    } catch (l) {
...
var ft = md, Sd = process.cwd, Wn = null, Cd = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return Wn || (Wn = Sd.call(process)), Wn;
};
try {
  process.cwd();
} catch {
...
function Rd(e) {
  ...
  }), Cd === "win32" && (e.rename = typeof e.rename != "function" ? e.rename : function(c) {
    function f(h, g, w) {
      var E = Date.now(), A = 0;
      c(h, g, function S(T) {
...
function Pd(e) {
  ...
  function r(n, i) {
    ...
    ja.call(this), this.path = n, this.fd = null, this.writable = !0, this.flags = "w", this.encoding = "binary", this.mode = 438, this.bytesWritten = 0, i = i || {};
...
var Id = Dd, Od = Object.getPrototypeOf || function(e) {
  return e.__proto__;
};
function Dd(e) {
...
var ie = St, Nd = bd, Fd = $d, xd = Id, $n = Bo, ve, Kn;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (ve = Symbol.for("graceful-fs.queue"), Kn = Symbol.for("graceful-fs.previous")) : (ve = "___graceful-fs.queue", Kn = "___graceful-fs.previous");
function Ld() {
}
function Gl(e, t) {
...
if (!ie[ve]) {
  ...
  Gl(ie, Ud), ie.close = function(e) {
    ...
    Mt(ie[ve]), Bl.equal(ie[ve].length, 0);
  });
}
$e[ve] || Gl($e, ie[ve]);
var De = jo(xd(ie));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !ie.__patched && (De = jo(ie), ie.__patched = !0);
function jo(e) {
  Nd(e), e.gracefulify = jo, e.createReadStream = te, e.createWriteStream = le;
  var t = e.readFile;
  e.readFile = r;
  function r(y, q, B) {
...
function zt(e) {
  Mt("ENQUEUE", e[0].name, e[1]), ie[ve].push(e), Ho();
}
var Pn;
function Ha() {
...
function Ho() {
  if (clearTimeout(Pn), Pn = void 0, ie[ve].length !== 0) {
    ...
    if (i === void 0)
      ...
      s >= d ? (Mt("RETRY", t.name, r), t.apply(null, r.concat([i]))) : ie[ve].push(e);
    }
    Pn === void 0 && (Pn = setTimeout(Ho, 0));
  }
}
(function(e) {
...
qo.makeDir = async (e, t) => (Yl(e), Vl.mkdir(e, {
  mode: zl(t),
  recursive: !0
}));
qo.makeDirSync = (e, t) => (Yl(e), Vl.mkdirSync(e, {
  mode: zl(t),
  recursive: !0
}));
const Md = Oe.fromPromise, { makeDir: Bd, makeDirSync: Hi } = qo, qi = Md(Bd);
var tt = {
  mkdirs: qi,
  mkdirsSync: Hi,
  // alias
...
function zd(e, t, r, n, i) {
  Wd.callbackify(Vd)(e, t, n, (o, a) => {
    ...
    return s.isDirectory() && Go(e, t) ? i(new Error(fi(e, t, r))) : i(null, { srcStat: s, destStat: l });
  });
}
function Xd(e, t, r, n) {
...
const xe = De, kr = oe, Kd = tt.mkdirs, Jd = Gt.pathExists, Qd = Kl.utimesMillis, Mr = gr;
function Zd(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Mr.checkParentPaths(e, a, t, "copy", (l) => l ? n(l) : r.filter ? Zl(qa, s, e, t, r, n) : qa(s, e, t, r, n));
  });
}
...
function Jn(e, t, r, n, i) {
  (n.dereference ? xe.stat : xe.lstat)(t, (a, s) => a ? i(a) : s.isDirectory() ? sh(s, e, t, r, n, i) : s.isFile() || s.isCharacterDevice() || s.isBlockDevice() ? th(s, e, t, r, n, i) : s.isSymbolicLink() ? uh(e, t, r, n, i) : s.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : s.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
function th(e, t, r, n, i, o) {
  return t ? rh(e, r, n, i, o) : ec(e, r, n, i, o);
}
...
function ec(e, t, r, n, i) {
  xe.copyFile(t, r, (o) => o ? i(o) : n.preserveTimestamps ? nh(e.mode, t, r, i) : di(r, e.mode, i));
}
function nh(e, t, r, n) {
  return ih(e) ? oh(r, e, (i) => i ? n(i) : Ga(e, t, r, n)) : Ga(e, t, r, n);
}
function ih(e) {
  return (e & 128) === 0;
}
...
function Ga(e, t, r, n) {
  ah(t, r, (i) => i ? n(i) : di(r, e, n));
}
function di(e, t, r) {
  return xe.chmod(e, t, r);
}
function ah(e, t, r) {
  xe.stat(e, (n, i) => n ? r(n) : Qd(t, i.atime, i.mtime, r));
}
function sh(e, t, r, n, i, o) {
  return t ? tc(r, n, i, o) : lh(e.mode, r, n, i, o);
}
...
function ch(e, t, r, n, i, o) {
  ...
  Mr.checkPaths(a, s, "copy", i, (l, d) => {
    if (l) return o(l);
    const { destStat: c } = d;
    eh(c, a, s, i, (f) => f ? o(f) : rc(e, r, n, i, o));
  });
}
function uh(e, t, r, n, i) {
  xe.readlink(t, (o, a) => {
    ...
    if (n.dereference && (a = kr.resolve(process.cwd(), a)), e)
      xe.readlink(r, (s, l) => s ? s.code === "EINVAL" || s.code === "UNKNOWN" ? xe.symlink(a, r, i) : i(s) : (n.dereference && (l = kr.resolve(process.cwd(), l)), Mr.isSrcSubdir(a, l) ? i(new Error(`Cannot copy '${a}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Mr.isSrcSubdir(l, a) ? i(new Error(`Cannot overwrite '${l}' with '${a}'.`)) : fh(a, r, i)));
    else
...
var dh = Zd;
const Se = De, Br = oe, hh = tt.mkdirsSync, ph = Kl.utimesMillisSync, jr = gr;
function mh(e, t, r) {
  ...
  return jr.checkParentPathsSync(e, n, t, "copy"), gh(i, e, t, r);
}
function gh(e, t, r, n) {
  if (n.filter && !n.filter(t, r)) return;
  const i = Br.dirname(r);
  return Se.existsSync(i) || hh(i), nc(e, t, r, n);
}
function yh(e, t, r, n) {
...
function nc(e, t, r, n) {
  ...
  if (o.isDirectory()) return Sh(o, e, t, r, n);
  if (o.isFile() || o.isCharacterDevice() || o.isBlockDevice()) return Eh(o, e, t, r, n);
  if (o.isSymbolicLink()) return Rh(e, t, r, n);
  throw o.isSocket() ? new Error(`Cannot copy a socket file: ${t}`) : o.isFIFO() ? new Error(`Cannot copy a FIFO pipe: ${t}`) : new Error(`Unknown file: ${t}`);
}
function Eh(e, t, r, n, i) {
  return t ? wh(e, r, n, i) : ic(e, r, n, i);
}
function wh(e, t, r, n) {
  if (n.overwrite)
    return Se.unlinkSync(r), ic(e, t, r, n);
  if (n.errorOnExist)
    throw new Error(`'${r}' already exists`);
}
function ic(e, t, r, n) {
  return Se.copyFileSync(t, r), n.preserveTimestamps && vh(e.mode, t, r), Wo(r, e.mode);
}
function vh(e, t, r) {
  return _h(e) && Ah(r, e), Th(t, r);
}
function _h(e) {
  return (e & 128) === 0;
}
...
function Th(e, t) {
  ...
  return ph(t, r.atime, r.mtime);
}
function Sh(e, t, r, n, i) {
  return t ? oc(r, n, i) : Ch(e.mode, r, n, i);
}
function Ch(e, t, r, n) {
  return Se.mkdirSync(r), oc(t, r, n), Wo(r, e);
}
function oc(e, t, r) {
  Se.readdirSync(e).forEach((n) => bh(n, e, t, r));
}
function bh(e, t, r, n) {
...
function Rh(e, t, r, n) {
  ...
  if (n.dereference && (i = Br.resolve(process.cwd(), i)), e) {
    ...
    if (Se.statSync(r).isDirectory() && jr.isSrcSubdir(o, i))
...
const Wa = De, ac = oe, J = Bl, Hr = process.platform === "win32";
function sc(e) {
  [
    "unlink",
    "chmod",
    ...
    e[r] = e[r] || Wa[r], r = r + "Sync", e[r] = e[r] || Wa[r];
  }), e.maxBusyTries = e.maxBusyTries || 3;
}
function Yo(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), J(e, "rimraf: missing path"), J.strictEqual(typeof e, "string", "rimraf: path should be a string"), J.strictEqual(typeof r, "function", "rimraf: callback function required"), J(t, "rimraf: invalid options argument provided"), J.strictEqual(typeof t, "object", "rimraf: options should be object"), sc(t), Va(e, t, function i(o) {
    if (o) {
      if ((o.code === "EBUSY" || o.code === "ENOTEMPTY" || o.code === "EPERM") && n < t.maxBusyTries) {
        n++;
        const a = n * 100;
        return setTimeout(() => Va(e, t, i), a);
      }
    ...
    t.unlink(e, (o) => {
      if (o) {
        if (o.code === "ENOENT")
          return r(null);
        if (o.code === "EPERM")
          return Hr ? Ya(e, t, o, r) : Vn(e, t, o, r);
        if (o.code === "EISDIR")
          return Vn(e, t, o, r);
      }
      return r(o);
...
var Nh = Yo;
Yo.sync = lc;
const Qn = De, Fh = Oe.fromCallback, cc = Nh;
function xh(e, t) {
...
const Uh = Oe.fromPromise, uc = qt, fc = oe, dc = tt, hc = hi, Xa = Uh(async function(t) {
  let r;
  try {
...
const Mh = Oe.fromCallback, pc = oe, mt = De, mc = tt;
function Bh(e, t) {
  function r() {
    mt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const qh = Oe.fromCallback, gc = oe, pt = De, yc = tt, Gh = Gt.pathExists, { areIdentical: Ec } = gr;
function Wh(e, t, r) {
  function n(i, o) {
    pt.link(i, o, (a) => {
      if (a) return r(a);
...
const gt = oe, Fr = De, zh = Gt.pathExists;
function Xh(e, t, r) {
  if (gt.isAbsolute(e))
    ...
    }));
  {
    ...
    return zh(i, (o, a) => o ? r(o) : a ? r(null, {
      toCwd: i,
      toDst: e
...
const tp = Oe.fromCallback, vc = oe, Ve = qt, _c = tt, rp = _c.mkdirs, np = _c.mkdirsSync, Ac = Jh, ip = Ac.symlinkPaths, op = Ac.symlinkPathsSync, Tc = ep, ap = Tc.symlinkType, sp = Tc.symlinkTypeSync, lp = Gt.pathExists, { areIdentical: Sc } = gr;
function cp(e, t, r, n) {
...
function up(e, t, r) {
  ...
  const i = op(e, t);
  e = i.toDst, r = sp(i.toCwd, r);
  const o = vc.dirname(t);
  return Ve.existsSync(o) || np(o), Ve.symlinkSync(e, t, r);
}
var fp = {
  createSymlink: tp(cp),
  createSymlinkSync: up
};
const { createFile: Qa, createFileSync: Za } = Hh, { createLink: es, createLinkSync: ts } = Yh, { createSymlink: rs, createSymlinkSync: ns } = fp;
var dp = {
  // file
  createFile: Qa,
  createFileSync: Za,
...
var zo = { stringify: hp, stripBom: pp };
let hr;
try {
  hr = De;
} catch {
...
const pi = Oe, { stringify: Cc, stripBom: bc } = zo;
...
const Tp = Oe.fromCallback, xr = De, Rc = oe, $c = tt, Sp = Gt.pathExists;
function Cp(e, t, r, n) {
...
const { stringify: Rp } = zo, { outputFile: $p } = Xo;
async function Pp(e, t, r = {}) {
  const n = Rp(t, r);
  await $p(e, n, r);
}
var Ip = Pp;
const { stringify: Op } = zo, { outputFileSync: Dp } = Xo;
function Np(e, t, r) {
  const n = Op(t, r);
  Dp(e, n, r);
}
var Fp = Np;
const xp = Oe.fromPromise, Ie = Ap;
Ie.outputJson = xp(Ip);
Ie.outputJsonSync = Fp;
...
var Lp = Ie;
const Up = De, So = oe, kp = Vo.copy, Pc = hi.remove, Mp = tt.mkdirp, Bp = Gt.pathExists, is = gr;
function jp(e, t, r, n) {
  typeof r == "function" && (n = r, r = {}), r = r || {};
  const i = r.overwrite || r.clobber || !1;
  is.checkPaths(e, t, "move", r, (o, a) => {
    if (o) return n(o);
    const { srcStat: s, isChangingCase: l = !1 } = a;
    is.checkParentPaths(e, s, t, "move", (d) => {
      if (d) return n(d);
      if (Hp(t)) return os(e, t, i, l, n);
      Mp(So.dirname(t), (c) => c ? n(c) : os(e, t, i, l, n));
    });
  });
}
function Hp(e) {
...
function os(e, t, r, n, i) {
  ...
  Bp(t, (o, a) => o ? i(o) : a ? i(new Error("dest already exists.")) : Gi(e, t, r, i));
}
function Gi(e, t, r, n) {
  Up.rename(e, t, (i) => i ? i.code !== "EXDEV" ? n(i) : qp(e, t, r, n) : n());
}
function qp(e, t, r, n) {
  kp(e, t, {
    overwrite: r,
...
var Gp = jp;
const Ic = De, Co = oe, Wp = Vo.copySync, Oc = hi.removeSync, Vp = tt.mkdirpSync, as = gr;
function Yp(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: o = !1 } = as.checkPathsSync(e, t, "move", r);
  return as.checkParentPathsSync(e, i, t, "move"), zp(t) || Vp(Co.dirname(t)), Xp(e, t, n, o);
}
function zp(e) {
...
const em = jl;
class tm extends em.EventEmitter {
  get cancelled() {
...
vt.CancellationToken = tm;
class bo extends Error {
  constructor() {
    super("cancelled");
  }
}
vt.CancellationError = bo;
var yr = {};
...
var Pe = {}, Ro = { exports: {} }, On = { exports: {} }, Vi, ss;
function nm() {
  if (ss) return Vi;
  ss = 1;
...
function Dc() {
  ...
  ls = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = d, n.disable = s, n.enable = o, n.enabled = l, n.humanize = nm(), n.destroy = c, Object.keys(t).forEach((f) => {
      n[f] = t[f];
...
var Dn = { exports: {} }, zi, us;
function om() {
  return us || (us = 1, zi = (e, t = process.argv) => {
...
function am() {
  if (fs) return Xi;
  fs = 1;
  const e = ci, t = Hl, r = om(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Ro.exports = im() : Ro.exports = sm();
var lm = Ro.exports, nn = {};
Object.defineProperty(nn, "__esModule", { value: !0 });
nn.ProgressCallbackTransform = void 0;
const cm = Zr;
class um extends cm.Transform {
  constructor(t, r, n) {
...
nn.ProgressCallbackTransform = um;
Object.defineProperty(Pe, "__esModule", { value: !0 });
Pe.DigestTransform = Pe.HttpExecutor = Pe.HttpError = void 0;
Pe.createHttpError = Po;
Pe.parseJson = Em;
Pe.configureRequestOptionsFromUrl = Fc;
Pe.configureRequestUrl = Jo;
Pe.safeGetHeader = fr;
Pe.configureRequestOptions = Zn;
Pe.safeStringifyJson = ei;
const fm = en, dm = lm, hm = St, pm = Zr, $o = Ct, mm = vt, hs = yr, gm = nn, Nt = (0, dm.default)("electron-builder");
...
class tr {
  ...
  request(t, r = new mm.CancellationToken(), n) {
    Zn(t);
  ...
  static retryOnServerError(t, r = 3) {
    for (let n = 0; ; n++)
      try {
        ...
        if (n < r && (i instanceof Ko && i.isServerError() || i.code === "EPIPE"))
          continue;
        throw i;
      }
  }
...
class Io extends pm.Transform {
  ...
  validate() {
    if (this._actual == null)
      throw (0, hs.newError)("Not finished yet", "ERR_STREAM_NOT_FINISHED");
    if (this._actual !== this.expected)
      throw (0, hs.newError)(`${this.algorithm} checksum mismatch, expected ${this.expected}, got ${this._actual}`, "ERR_CHECKSUM_MISMATCH");
    return null;
  }
}
Pe.DigestTransform = Io;
function wm(e, t, r) {
...
function vm(e, t) {
  if (!wm(fr(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const a = fr(t, "content-length");
    a != null && r.push(new gm.ProgressCallbackTransform(parseInt(a, 10), e.options.cancellationToken, e.options.onProgress));
  }
...
on.githubUrl = Am;
on.githubTagPrefix = Tm;
on.getS3LikeProviderBaseUrl = Sm;
...
const kc = en, Mc = yr, Pm = "options.name must be either a string or a Buffer", ps = (0, kc.randomBytes)(16);
ps[0] = ps[0] | 1;
const zn = {}, W = [];
for (let e = 0; e < 256; e++) {
...
function Im(e, t, r, n, i = Lr.ASCII) {
  const o = (0, kc.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Mc.newError)(Pm, "ERR_INVALID_UUID_NAME");
    ...
    function G(p, u) {
      if (p.opt.xmlns) {
        ...
        for (var re = 0, ae = p.attribList.length; re < ae; re++) {
          var ye = p.attribList[re], Ae = ye[0], st = ye[1], fe = I(Ae, !0), He = fe.prefix, Ni = fe.local, pn = He === "" ? "" : C.ns[He] || "", _r = {
            name: Ae,
            value: st,
            prefix: He,
            local: Ni,
          ...
          He && He !== "xmlns" && !pn && (b(p, "Unbound namespace prefix: " + JSON.stringify(He)), _r.uri = He), p.tag.attributes[Ae] = _r, M(p, "onattribute", _r);
        }
...
` ? (u.line++, u.column = 0) : u.column++);
          ...
          case y.SGML_DECL:
            ...
            ), u.doctype = "", u.sgmlDecl = "") : _ === ">" ? (M(u, "onsgmldeclaration", u.sgmlDecl), u.sgmlDecl = "", u.state = y.TEXT) : (te(_) && (u.state = y.SGML_DECL_QUOTED), u.sgmlDecl += _);
            continue;
          case y.SGML_DECL_QUOTED:
            _ === u.q && (u.state = y.SGML_DECL, u.q = ""), u.sgmlDecl += _;
            continue;
          case y.DOCTYPE:
            _ === ">" ? (u.state = y.TEXT, M(u, "ondoctype", u.doctype), u.doctype = !0) : (u.doctype += _, _ === "[" ? u.state = y.DOCTYPE_DTD : te(_) && (u.state = y.DOCTYPE_QUOTED, u.q = _));
            continue;
          case y.DOCTYPE_QUOTED:
            u.doctype += _, _ === u.q && (u.q = "", u.state = y.DOCTYPE);
            continue;
          case y.DOCTYPE_DTD:
            _ === "]" ? (u.doctype += _, u.state = y.DOCTYPE) : _ === "<" ? (u.state = y.OPEN_WAKA, u.startTagPosition = u.position) : te(_) ? (u.doctype += _, u.state = y.DOCTYPE_DTD_QUOTED, u.q = _) : u.doctype += _;
            continue;
          ...
          case y.ATTRIB_VALUE:
            if (x(_))
              continue;
            te(_) ? (u.q = _, u.state = y.ATTRIB_VALUE_QUOTED) : (u.opt.unquotedAttributeValues || R(u, "Unquoted attribute value"), u.state = y.ATTRIB_VALUE_UNQUOTED, u.attribValue = _);
            continue;
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            } else V(u.entity.length ? D : T, _) ? u.entity += _ : (b(u, "Invalid character in entity name"), u[ye] += "&" + u.entity + _, u.entity = "", u.state = ae);
            continue;
          default:
...
class jc {
  ...
  getElements(t, r = !1) {
    return this.elements === null ? [] : this.elements.filter((n) => gs(n, t, r));
  }
...
function Vm(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    if (qm.indexOf(r) === -1)
      throw new ys('Unknown option "' + r + '" is met in definition of "' + e + '" YAML type.');
  }), this.options = t, this.tag = e, this.kind = t.kind || null, this.resolve = t.resolve || function() {
    return !0;
  }, this.construct = t.construct || function(r) {
    return r;
  }, this.instanceOf = t.instanceOf || null, this.predicate = t.predicate || null, this.represent = t.represent || null, this.representName = t.representName || null, this.defaultStyle = t.defaultStyle || null, this.multi = t.multi || !1, this.styleAliases = Wm(t.styleAliases || null), Gm.indexOf(this.kind) === -1)
    throw new ys('Unknown kind "' + this.kind + '" is specified for "' + e + '" YAML type.');
}
var Ne = Vm, Rr = sn, Qi = Ne;
function Es(e, t) {
  var r = [];
...
Oo.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = Es(i, "implicit"), i.compiledExplicit = Es(i, "explicit"), i.compiledTypeMap = Ym(i.compiledImplicit, i.compiledExplicit), i;
};
var Gc = Oo, zm = Ne, Wc = new zm("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), Xm = Ne, Vc = new Xm("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), Km = Ne, Yc = new Km("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Xc = new Qm("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: Zm,
  construct: eg,
  predicate: tg,
...
var Kc = new rg("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: ng,
  construct: ig,
  predicate: og,
...
function hg(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && e % 1 === 0 && !ag.isNegativeZero(e);
}
var Jc = new sg("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: fg,
  construct: dg,
  predicate: hg,
...
}), Qc = Ye, pg = Ne, mg = new RegExp(
  // 2.5e4, 2.5 and integers
  "^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"
);
function gg(e) {
  return !(e === null || !mg.test(e) || // Quick hack to not allow integers end with `_`
...
var Zc = new pg("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: gg,
  construct: yg,
  predicate: vg,
...
var iu = new _g("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: Ag,
  construct: Tg,
  instanceOf: Date,
...
var ou = new Cg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: bg
}), Rg = Ne, ta = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function $g(e) {
  if (e === null) return !1;
  var t, r, n = 0, i = e.length, o = ta;
  for (r = 0; r < i; r++)
...
var au = new Rg("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: $g,
  construct: Pg,
  predicate: Og,
  represent: Ig
}), Dg = Ne, Ng = Object.prototype.hasOwnProperty, Fg = Object.prototype.toString;
function xg(e) {
  if (e === null) return !0;
  var t = [], r, n, i, o, a, s = e;
  for (r = 0, n = s.length; r < n; r += 1) {
    if (i = s[r], a = !1, Fg.call(i) !== "[object Object]") return !1;
    for (o in i)
      if (Ng.call(i, o))
        if (!a) a = !0;
        else return !1;
...
var su = new Dg("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: xg,
  construct: Lg
}), Ug = Ne, kg = Object.prototype.toString;
function Mg(e) {
  if (e === null) return !0;
  var t, r, n, i, o, a = e;
  for (o = new Array(a.length), t = 0, r = a.length; t < r; t += 1) {
    if (n = a[t], kg.call(n) !== "[object Object]" || (i = Object.keys(n), i.length !== 1)) return !1;
    o[t] = [i[0], n[i[0]]];
  }
  return !0;
}
...
var lu = new Ug("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: Mg,
  construct: Bg
}), jg = Ne, Hg = Object.prototype.hasOwnProperty;
function qg(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
...
var cu = new jg("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: qg,
  construct: Gg
}), ra = tu.extend({
...
}), Lt = Ye, uu = sn, Wg = Hm, Vg = ra, _t = Object.prototype.hasOwnProperty, ti = 1, fu = 2, du = 3, ri = 4, Zi = 1, Yg = 2, ws = 3, zg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Xg = /[\x85\u2028\u2029]/, Kg = /[,\[\]\{\}]/, hu = /^(?:!|!!|![a-z\-]+!)$/i, pu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function vs(e) {
...
function Eu(e, t) {
  ...
  return r.snippet = Wg(r), new uu(t, r);
}
function L(e, t) {
  throw Eu(e, t);
}
...
function yt(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else zg.test(s) && L(e, "the stream contains non-printable characters");
    e.result += s;
  }
}
function Ts(e, t, r, n) {
...
function nr(e, t, r, n, i, o, a, s, l) {
  ...
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), d = 0, c = i.length; d < c; d += 1)
      Array.isArray(i[d]) && L(e, "nested arrays are not supported inside keys"), typeof i == "object" && vs(i[d]) === "[object Object]" && (i[d] = "[object Object]");
  if (typeof i == "object" && vs(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    if (Array.isArray(o))
...
function ce(e, t, r) {
  for (var n = 0, i = e.input.charCodeAt(e.position); i !== 0; ) {
    ...
    if (t && i === 35)
      ...
      while (i !== 10 && i !== 13 && i !== 0);
    if (et(i))
      for (na(e), i = e.input.charCodeAt(e.position), n++, e.lineIndent = 0; i === 32; )
...
function r0(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", o = a = e.position, s = !1; g !== 0; ) {
    ...
    s && (yt(e, o, a, !1), ia(e, e.line - l), o = a = e.position, s = !1), Bt(g) || (a = e.position + 1), g = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (yt(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else et(r) ? (yt(e, n, i, !0), ia(e, ce(e, !1, t)), n = i = e.position) : e.position === e.lineStart && gi(e) ? L(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (s = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (s === 92) {
      if (yt(e, r, e.position, !0), s = e.input.charCodeAt(++e.position), et(s))
        ...
        for (i = a, o = 0; i > 0; i--)
          s = e.input.charCodeAt(++e.position), (a = Jg(s)) >= 0 ? o = (o << 4) + a : L(e, "expected hexadecimal character");
        e.result += e0(o), e.position++;
      } else
        L(e, "unknown escape sequence");
      r = n = e.position;
    } else et(s) ? (yt(e, r, n, !0), ia(e, ce(e, !1, t)), r = n = e.position) : e.position === e.lineStart && gi(e) ? L(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function a0(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      Zi === i ? i = f === 43 ? ws : Yg : L(e, "repeat of a chomping mode identifier");
    else if ((c = Zg(f)) >= 0)
  ...
  for (; f !== 0; ) {
    for (na(e), e.lineIndent = 0, f = e.input.charCodeAt(e.position); (!a || e.lineIndent < s) && f === 32; )
...
function l0(e) {
  ...
  if (e.tag !== null && L(e, "duplication of a tag property"), a = e.input.charCodeAt(++e.position), a === 60 ? (r = !0, a = e.input.charCodeAt(++e.position)) : a === 33 ? (n = !0, i = "!!", a = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    o = e.input.slice(t, e.position), Kg.test(o) && L(e, "tag suffix cannot contain flow indicator characters");
  }
...
function mr(e, t, r, n, i) {
  ...
  if (s && (s = d || i), (l === 1 || ri === r) && (ti === r || fu === r ? E = t : E = t + 1, A = e.position - e.lineStart, l === 1 ? s && (Ss(e, A) || s0(e, A, E)) || o0(e, E) ? c = !0 : (a && a0(e, E) || n0(e, E) || i0(e, E) ? c = !0 : u0(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : r0(e, E, ti === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = s && Ss(e, A))), e.tag === null)
...
function f0(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (a = e.input.charCodeAt(e.position)) !== 0 && (ce(e, !0, -1), a = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || a !== 37)); ) {
    ...
    a !== 0 && na(e), _t.call(As, n) ? As[n](e, n, i) : ni(e, 'unknown document directive "' + n + '"');
  }
  if (ce(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, ce(e, !0, -1)) : o && L(e, "directives end mark is expected"), mr(e, e.lineIndent - 1, ri, !1, !0), ce(e, !0, -1), e.checkLineBreaks && Xg.test(e.input.slice(t, e.position)) && ni(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && gi(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  var r = new t0(e, t), n = e.indexOf("\0");
...
ea.loadAll = d0;
ea.load = h0;
var vu = {}, yi = Ye, ln = sn, p0 = ra, _u = Object.prototype.toString, Au = Object.prototype.hasOwnProperty, oa = 65279, m0 = 9, Gr = 10, g0 = 13, y0 = 32, E0 = 33, w0 = 34, Do = 35, v0 = 37, _0 = 38, A0 = 39, T0 = 42, Tu = 44, S0 = 45, ii = 58, C0 = 61, b0 = 62, R0 = 63, $0 = 64, Su = 91, Cu = 93, P0 = 96, bu = 123, I0 = 124, Ru = 125, Ce = {};
Ce[0] = "\\0";
Ce[7] = "\\a";
Ce[8] = "\\b";
Ce[9] = "\\t";
...
var x0 = 1, Wr = 2;
function L0(e) {
  this.schema = e.schema || p0, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = yi.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = N0(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Wr : x0, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function Cs(e, t) {
...
function Rs(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== Tu && e !== Su && e !== Cu && e !== bu && e !== Ru) && e !== Do && !(t === ii && !i) || bs(t) && !oi(t) && e === Do || t === ii && i
  );
}
function k0(e) {
  return Vr(e) && e !== oa && !oi(e) && e !== S0 && e !== R0 && e !== ii && e !== Tu && e !== Su && e !== Cu && e !== bu && e !== Ru && e !== Do && e !== _0 && e !== T0 && e !== E0 && e !== I0 && e !== C0 && e !== b0 && e !== A0 && e !== w0 && e !== v0 && e !== $0 && e !== P0;
}
function M0(e) {
  return !oi(e) && e !== ii;
}
...
var Pu = 1, Fo = 2, Iu = 3, Ou = 4, er = 5;
function B0(e, t, r, n, i, o, a, s) {
  var l, d = 0, c = null, f = !1, h = !1, g = n !== -1, w = -1, E = k0(Dr(e, 0)) && M0(Dr(e, e.length - 1));
  if (t || a)
  ...
  return !f && !h ? E && !a && !i(e) ? Pu : o === Wr ? er : Fo : r > 9 && $u(e) ? er : a ? o === Wr ? er : Fo : h ? Ou : Iu;
}
function j0(e, t, r, n, i) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === Wr ? '""' : "''";
    if (!e.noCompatMode && (O0.indexOf(t) !== -1 || D0.test(t)))
    ...
    switch (B0(
      ...
      case Fo:
        return "'" + t.replace(/'/g, "''") + "'";
      case Iu:
        return "|" + $s(t, e.indent) + Ps(Cs(t, o));
      case Ou:
        return ">" + $s(t, e.indent) + Ps(Cs(H0(t, a), o));
      case er:
        return '"' + q0(t) + '"';
      default:
...
function H0(e, t) {
  for (var r = /(\n+)([^\n]*)/g, n = function() {
    var d = e.indexOf(`
`);
    return d = d !== -1 ? d : e.length, r.lastIndex = d, Is(e.slice(0, d), t);
  }(), i = e[0] === `
` || e[0] === " ", o, a; a = r.exec(e); ) {
    var s = a[1], l = a[2];
    o = l[0] === " ", n += s + (!i && !o && l !== "" ? `
...
function q0(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Dr(e, i), n = Ce[r], !n && Vr(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || F0(r);
  return t;
}
function G0(e, t, r) {
  var n = "", i = e.tag, o, a, s;
...
function Os(e, t, r, n) {
  ...
  for (a = 0, s = r.length; a < s; a += 1)
    l = r[a], e.replacer && (l = e.replacer.call(r, String(a), l)), (at(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && at(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += No(e, t)), e.dump && Gr === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = o, e.dump = i || "[]";
}
function W0(e, t, r) {
...
function V0(e, t, r, n) {
  ...
  for (s = 0, l = a.length; s < l; s += 1)
    h = "", (!n || i !== "") && (h += No(e, t)), d = a[s], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), at(e, t + 1, d, !0, !0, !0) && (f = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, f && (e.dump && Gr === e.dump.charCodeAt(0) ? h += "?" : h += "? "), h += e.dump, f && (h += No(e, t)), at(e, t + 1, c, !0, f) && (e.dump && Gr === e.dump.charCodeAt(0) ? h += ":" : h += ": ", h += e.dump, i += h));
  e.tag = o, e.dump = i || "{}";
}
function Ds(e, t, r) {
  var n, i, o, a, s, l;
...
function at(e, t, r, n, i, o, a) {
  e.tag = null, e.dump = r, Ds(e, r, !1) || Ds(e, r, !0);
  ...
  if (c && (f = e.duplicates.indexOf(r), h = f !== -1), (e.tag !== null && e.tag !== "?" || h || e.indent !== 2 && t > 0) && (i = !1), h && e.usedDuplicates[f])
    ...
    if (c && h && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), s === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (V0(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : (W0(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
    else if (s === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !a && t > 0 ? Os(e, t - 1, e.dump, i) : Os(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : (G0(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
    else if (s === "[object String]")
      e.tag !== "?" && j0(e, e.dump, t, o, l);
    else {
...
function Y0(e, t) {
  var r = [], n = [], i, o;
  for (xo(e, r, n), i = 0, o = n.length; i < o; i += 1)
...
_e.Type = Ne;
_e.Schema = Gc;
_e.FAILSAFE_SCHEMA = zc;
_e.JSON_SCHEMA = eu;
_e.CORE_SCHEMA = tu;
_e.DEFAULT_SCHEMA = ra;
_e.load = Du.load;
_e.loadAll = Du.loadAll;
_e.dump = X0.dump;
_e.YAMLException = sn;
_e.types = {
  binary: au,
...
_e.safeLoad = aa("safeLoad", "load");
_e.safeLoadAll = aa("safeLoadAll", "loadAll");
_e.safeDump = aa("safeDump", "dump");
var Ei = {};
...
Ei.Lazy = K0;
var Lo = { exports: {} };
const J0 = "2.0.0", Nu = 256, Q0 = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, Z0 = 16, ey = Nu - 6, ty = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var cn = Lo.exports;
const ny = Object.freeze({ loose: !0 }), iy = Object.freeze({}), oy = (e) => e ? typeof e != "object" ? ny : e : iy;
var sa = oy;
const Ns = /^[0-9]+$/, Fu = (e, t) => {
...
const Fn = vi, { MAX_LENGTH: Fs, MAX_SAFE_INTEGER: xn } = wi, { safeRe: Ln, t: Un } = cn, sy = sa, { compareIdentifiers: eo } = xu;
let ly = class Ze {
  constructor(t, r) {
    if (r = sy(r), t instanceof Ze) {
...
var yy = gy;
const Us = Er, Ey = (e, t) => {
  const r = Us(e, null, !0), n = Us(t, null, !0), i = r.compare(n);
  if (i === 0)
    return null;
...
var wy = Ey;
const vy = Fe, _y = (e, t) => new vy(e, t).major;
var Ay = _y;
const Ty = Fe, Sy = (e, t) => new Ty(e, t).minor;
var Cy = Sy;
const by = Fe, Ry = (e, t) => new by(e, t).patch;
var $y = Ry;
const Py = Er, Iy = (e, t) => {
  const r = Py(e, t);
...
var Oy = Iy;
const ks = Fe, Dy = (e, t, r) => new ks(e, r).compare(new ks(t, r));
var ze = Dy;
const Ny = ze, Fy = (e, t, r) => Ny(t, e, r);
var xy = Fy;
const Ly = ze, Uy = (e, t) => Ly(e, t, !0);
var ky = Uy;
const Ms = Fe, My = (e, t, r) => {
  const n = new Ms(e, r), i = new Ms(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var la = My;
const By = la, jy = (e, t) => e.sort((r, n) => By(r, n, t));
var Hy = jy;
const qy = la, Gy = (e, t) => e.sort((r, n) => qy(n, r, t));
var Wy = Gy;
...
var ua = tE;
const rE = ze, nE = (e, t, r) => rE(e, t, r) <= 0;
var fa = nE;
const iE = Lu, oE = Uu, aE = _i, sE = ua, lE = ca, cE = fa, uE = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var ku = uE;
const fE = Fe, dE = Er, { safeRe: kn, t: Mn } = cn, hE = (e, t) => {
  if (e instanceof fE)
    return e;
...
function Xe() {
  ...
  to = t;
  const r = gE, n = new r(), i = sa, o = Ai(), a = vi, s = Fe, {
    safeRe: l,
    t: d,
    ...
    return O;
  }, T = (P, R) => (P = P.replace(l[d.BUILD], ""), a("comp", P, R), P = le(P, R), a("caret", P), P = x(P, R), a("tildes", P), P = Ue(P, R), a("xrange", P), P = q(P, R), a("stars", P), P), D = (P) => !P || P.toLowerCase() === "x" || P === "*", x = (P, R) => P.trim().split(/\s+/).map((O) => te(O, R)).join(" "), te = (P, R) => {
  ...
  }, le = (P, R) => P.trim().split(/\s+/).map((O) => V(O, R)).join(" "), V = (P, R) => {
    a("caret", P, R);
...
function Ai() {
  ...
  ro = t;
  const r = sa, { safeRe: n, t: i } = cn, o = ku, a = vi, s = Fe, l = Xe();
  return ro;
}
const yE = Xe(), EE = (e, t, r) => {
  try {
    t = new yE(t, r);
  } catch {
    return !1;
...
var Ti = EE;
const wE = Xe(), vE = (e, t) => new wE(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var _E = vE;
const AE = Fe, TE = Xe(), SE = (e, t, r) => {
  ...
  return e.forEach((a) => {
    o.test(a) && (!n || i.compare(a) === -1) && (n = a, i = new AE(n, r));
  }), n;
};
var CE = SE;
const bE = Fe, RE = Xe(), $E = (e, t, r) => {
  let n = null, i = null, o = null;
  try {
    o = new RE(t, r);
  } catch {
...
var PE = $E;
const no = Fe, IE = Xe(), Hs = _i, OE = (e, t) => {
  e = new IE(e, t);
  let r = new no("0.0.0");
...
var xE = FE;
const LE = Fe, Mu = Ai(), { ANY: UE } = Mu, kE = Xe(), ME = Ti, qs = _i, Gs = ca, BE = fa, jE = ua, HE = (e, t, r, n) => {
  e = new LE(e, n), t = new kE(t, n);
  let i, o, a, s, l;
  switch (r) {
    case ">":
      i = qs, o = BE, a = Gs, s = ">", l = ">=";
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let f = null, h = null;
    if (c.forEach((g) => {
      g.semver === UE && (g = new Mu(">=0.0.0")), f = f || g, h = h || g, i(g.semver, f.semver, n) ? f = g : a(g.semver, h.semver, n) && (h = g);
...
var da = HE;
const qE = da, GE = (e, t, r) => qE(e, t, ">", r);
var WE = GE;
const VE = da, YE = (e, t, r) => VE(e, t, "<", r);
var zE = YE;
const Ws = Xe(), XE = (e, t, r) => (e = new Ws(e, r), t = new Ws(t, r), e.intersects(t, r));
var KE = XE;
const JE = Ti, QE = ze;
var ZE = (e, t, r) => {
  const n = [];
  let i = null, o = null;
  const a = e.sort((c, f) => QE(c, f, r));
  for (const c of a)
    JE(c, t, r) ? (o = c, i || (i = c)) : (o && n.push([i, o]), o = null, i = null);
  i && n.push([i, null]);
  const s = [];
  for (const [c, f] of n)
...
const Vs = Xe(), ha = Ai(), { ANY: io } = ha, $r = Ti, pa = ze, ew = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, tw = [new ha(">=0.0.0-0")], Ys = [new ha(">=0.0.0")], rw = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === io) {
    if (t.length === 1 && t[0].semver === io)
      return !0;
    r.includePrerelease ? e = tw : e = Ys;
  }
  if (t.length === 1 && t[0].semver === io) {
  ...
  let i, o;
  for (const g of e)
    g.operator === ">" || g.operator === ">=" ? i = zs(i, g, r) : g.operator === "<" || g.operator === "<=" ? o = Xs(o, g, r) : n.add(g.semver);
  if (n.size > 1)
    return null;
  let a;
  if (i && o) {
    if (a = pa(i.semver, o.semver, r), a > 0)
      return null;
...
var nw = ew;
const oo = cn, Ks = wi, iw = Fe, Js = xu, ow = Er, aw = dy, sw = my, lw = yy, cw = wy, uw = Ay, fw = Cy, dw = $y, hw = Oy, pw = ze, mw = xy, gw = ky, yw = la, Ew = Hy, ww = Wy, vw = _i, _w = ca, Aw = Lu, Tw = Uu, Sw = ua, Cw = fa, bw = ku, Rw = pE, $w = Ai(), Pw = Xe(), Iw = Ti, Ow = _E, Dw = CE, Nw = PE, Fw = DE, xw = xE, Lw = da, Uw = WE, kw = zE, Mw = KE, Bw = ZE, jw = nw;
var Bu = {
  parse: ow,
  valid: aw,
  clean: sw,
  ...
  src: oo.src,
  tokens: oo.t,
  SEMVER_SPEC_VERSION: Ks.SEMVER_SPEC_VERSION,
  RELEASE_TYPES: Ks.RELEASE_TYPES,
  compareIdentifiers: Js.compareIdentifiers,
  rcompareIdentifiers: Js.rcompareIdentifiers
}, un = {}, ai = { exports: {} };
ai.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, o = 2, a = 9007199254740991, s = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", f = "[object Date]", h = "[object Error]", g = "[object Function]", w = "[object GeneratorFunction]", E = "[object Map]", A = "[object Number]", S = "[object Null]", T = "[object Object]", D = "[object Promise]", x = "[object Proxy]", te = "[object RegExp]", le = "[object Set]", V = "[object String]", Ue = "[object Symbol]", y = "[object Undefined]", q = "[object WeakMap]", B = "[object ArrayBuffer]", M = "[object DataView]", X = "[object Float32Array]", P = "[object Float64Array]", R = "[object Int8Array]", O = "[object Int16Array]", b = "[object Int32Array]", N = "[object Uint8Array]", I = "[object Uint8ClampedArray]", k = "[object Uint16Array]", G = "[object Uint32Array]", j = /[\\^$.*+?()[\]{}|]/g, K = /^\[object .+?Constructor\]$/, he = /^(?:0|[1-9]\d*)$/, U = {};
  U[X] = U[P] = U[R] = U[O] = U[b] = U[N] = U[I] = U[k] = U[G] = !0, U[s] = U[l] = U[B] = U[c] = U[M] = U[f] = U[h] = U[g] = U[E] = U[A] = U[T] = U[te] = U[le] = U[V] = U[q] = !1;
  var Je = typeof $e == "object" && $e && $e.Object === Object && $e, p = typeof self == "object" && self && self.Object === Object && self, u = Je || p || Function("return this")(), C = t && !t.nodeType && t, _ = C && !0 && e && !e.nodeType && e, Y = _ && _.exports === C, re = Y && Je.process, ae = function() {
    try {
  ...
  var cf = Array.prototype, uf = Function.prototype, gn = Object.prototype, Fi = u["__core-js_shared__"], Aa = uf.toString, Qe = gn.hasOwnProperty, Ta = function() {
    var m = /[^.]+$/.exec(Fi && Fi.keys && Fi.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Sa = gn.toString, ff = RegExp(
    "^" + Aa.call(Qe).replace(j, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Ca = Y ? u.Buffer : void 0, yn = u.Symbol, ba = u.Uint8Array, Ra = gn.propertyIsEnumerable, df = cf.splice, $t = yn ? yn.toStringTag : void 0, $a = Object.getOwnPropertySymbols, hf = Ca ? Ca.isBuffer : void 0, pf = sf(Object.keys, Object), xi = Yt(u, "DataView"), Ar = Yt(u, "Map"), Li = Yt(u, "Promise"), Ui = Yt(u, "Set"), ki = Yt(u, "WeakMap"), Tr = Yt(Object, "create"), mf = Ot(xi), gf = Ot(Ar), yf = Ot(Li), Ef = Ot(Ui), wf = Ot(ki), Pa = yn ? yn.prototype : void 0, Mi = Pa ? Pa.valueOf : void 0;
  function Pt(m) {
  ...
  Pt.prototype.clear = vf, Pt.prototype.delete = _f, Pt.prototype.get = Af, Pt.prototype.has = Tf, Pt.prototype.set = Sf;
  function rt(m) {
    var v = -1, $ = m == null ? 0 : m.length;
    for (this.clear(); ++v < $; ) {
      var F = m[v];
  ...
  function bf(m) {
    ...
    if ($ < 0)
      return !1;
    var F = v.length - 1;
    return $ == F ? v.pop() : df.call(v, $, 1), --this.size, !0;
  }
  function Rf(m) {
    var v = this.__data__, $ = wn(v, m);
    return $ < 0 ? void 0 : v[$][1];
  ...
  rt.prototype.clear = Cf, rt.prototype.delete = bf, rt.prototype.get = Rf, rt.prototype.has = $f, rt.prototype.set = Pf;
  function It(m) {
    var v = -1, $ = m == null ? 0 : m.length;
    for (this.clear(); ++v < $; ) {
      var F = m[v];
  ...
  It.prototype.clear = If, It.prototype.delete = Of, It.prototype.get = Df, It.prototype.has = Nf, It.prototype.set = Ff;
  function En(m) {
    var v = -1, $ = m == null ? 0 : m.length;
  ...
  En.prototype.add = En.prototype.push = xf, En.prototype.has = Lf;
  function lt(m) {
  ...
  lt.prototype.clear = Uf, lt.prototype.delete = kf, lt.prototype.get = Mf, lt.prototype.has = Bf, lt.prototype.set = jf;
  function Hf(m, v) {
    var $ = _n(m), F = !$ && nd(m), Z = !$ && !F && Bi(m), H = !$ && !F && !Z && ka(m), se = $ || F || Z || H, pe = se ? He(m.length, String) : [], Ee = pe.length;
    for (var ne in m)
      Qe.call(m, ne) && !(se && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function Sr(m) {
    return m == null ? m === void 0 ? y : S : $t && $t in Object(m) ? Kf(m) : rd(m);
  }
  function Ia(m) {
    return Cr(m) && Sr(m) == s;
  }
  function Oa(m, v, $, F, Z) {
    return m === v ? !0 : m == null || v == null || !Cr(m) && !Cr(v) ? m !== m && v !== v : Gf(m, v, $, F, Oa, Z);
  }
  function Gf(m, v, $, F, Z, H) {
    var se = _n(m), pe = _n(v), Ee = se ? l : ct(m), ne = pe ? l : ct(v);
    Ee = Ee == s ? T : Ee, ne = ne == s ? T : ne;
    var ke = Ee == T, qe = ne == T, Te = Ee == ne;
    if (Te && Bi(m)) {
      if (!Bi(v))
        return !1;
      se = !0, ke = !1;
    ...
    if (Te && !ke)
      return H || (H = new lt()), se || ka(m) ? Da(m, v, $, F, Z, H) : zf(m, v, Ee, $, F, Z, H);
    if (!($ & i)) {
    ...
    return Te ? (H || (H = new lt()), Xf(m, v, $, F, Z, H)) : !1;
  }
  function Wf(m) {
    if (!Ua(m) || ed(m))
      return !1;
  ...
  function Vf(m) {
    return Cr(m) && La(m.length) && !!U[Sr(m)];
  }
  function Yf(m) {
    if (!td(m))
      return pf(m);
  ...
  function Da(m, v, $, F, Z, H) {
    var se = $ & i, pe = m.length, Ee = v.length;
    if (pe != Ee && !(se && Ee > pe))
      return !1;
    var ne = H.get(m);
    if (ne && H.get(v))
      return ne == v;
    var ke = -1, qe = !0, Te = $ & o ? new En() : void 0;
    for (H.set(m, v), H.set(v, m); ++ke < pe; ) {
      var Be = m[ke], je = v[ke];
      if (F)
        var ut = se ? F(je, Be, ke, v, m, H) : F(Be, je, ke, m, v, H);
      if (ut !== void 0) {
        if (ut)
          continue;
        qe = !1;
  ...
  function zf(m, v, $, F, Z, H, se) {
    switch ($) {
      ...
      case B:
        return !(m.byteLength != v.byteLength || !H(new ba(m), new ba(v)));
      case c:
      case f:
      case A:
        return Fa(+m, +v);
      ...
      case le:
        var Ee = F & i;
        if (pe || (pe = lf), m.size != v.size && !Ee)
          return !1;
        var ne = se.get(m);
        if (ne)
          return ne == v;
        F |= o, se.set(m, v);
        var ke = Da(pe(m), pe(v), F, Z, H, se);
        return se.delete(m), ke;
      case Ue:
        if (Mi)
  ...
  function Xf(m, v, $, F, Z, H) {
    var se = $ & i, pe = Na(m), Ee = pe.length, ne = Na(v), ke = ne.length;
    if (Ee != ke && !se)
      return !1;
    for (var qe = Ee; qe--; ) {
      var Te = pe[qe];
    ...
    for (var ut = se; ++qe < Ee; ) {
      ...
      var nt = m[Te], Dt = v[Te];
      if (F)
        var Ma = se ? F(Dt, nt, Te, v, m, H) : F(nt, Dt, Te, m, v, H);
      if (!(Ma === void 0 ? nt === Dt || Z(nt, Dt, $, F, H) : Ma)) {
        je = !1;
        break;
      }
  ...
  function vn(m, v) {
    var $ = m.__data__;
    return Zf(v) ? $[typeof v == "string" ? "string" : "hash"] : $.map;
  }
  function Yt(m, v) {
    var $ = _r(m, v);
    return Wf($) ? $ : void 0;
  ...
  var Jf = $a ? function(m) {
    return m == null ? [] : (m = Object(m), Ae($a(m), function(v) {
      return Ra.call(m, v);
    }));
  } : sd, ct = Sr;
  (xi && ct(new xi(new ArrayBuffer(1))) != M || Ar && ct(new Ar()) != E || Li && ct(Li.resolve()) != D || Ui && ct(new Ui()) != le || ki && ct(new ki()) != q) && (ct = function(m) {
  ...
  var nd = Ia(/* @__PURE__ */ function() {
    return arguments;
  }()) ? Ia : function(m) {
    return Cr(m) && Qe.call(m, "callee") && !Ra.call(m, "callee");
  }, _n = Array.isArray;
  function id(m) {
    return m != null && La(m.length) && !xa(m);
  }
  var Bi = hf || ld;
  function od(m, v) {
    return Oa(m, v);
...
un.createTempUpdateFile = Yw;
const qw = en, Gw = St, Qs = Hw, Ft = bt, Ur = oe;
class Ww {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Qs(this.versionInfo, r) && Qs(this.fileInfo.info, n.info) && await (0, Ft.pathExists)(t) ? t : null;
...
un.DownloadedUpdateHelper = Ww;
function Vw(e, t = "sha512", r = "base64", n) {
  return new Promise((i, o) => {
    const a = (0, qw.createHash)(t);
    a.on("error", o).setEncoding(r), (0, Gw.createReadStream)(e, {
      ...n,
...
Ke.newBaseUrl = Qw;
Ke.newUrlFromBase = Zw;
Ke.getChannelFilename = ev;
const Hu = Ct;
function Qw(e) {
...
var ue = {}, tv = "[object Symbol]", qu = /[\\^$.*+?()[\]{}|]/g, rv = RegExp(qu.source), nv = typeof $e == "object" && $e && $e.Object === Object && $e, iv = typeof self == "object" && self && self.Object === Object && self, ov = nv || iv || Function("return this")(), av = Object.prototype, sv = av.toString, el = ov.Symbol, tl = el ? el.prototype : void 0, rl = tl ? tl.toString : void 0;
function lv(e) {
  if (typeof e == "string")
    return e;
  if (uv(e))
...
function dv(e) {
  return e = fv(e), e && rv.test(e) ? e.replace(qu, "\\$&") : e;
}
var Gu = dv;
Object.defineProperty(ue, "__esModule", { value: !0 });
ue.Provider = void 0;
ue.findFile = yv;
ue.parseUpdateInfo = Ev;
ue.getFileList = Wu;
ue.resolveFiles = wv;
const At = de, hv = _e, pv = Ct, si = Ke, mv = Gu;
class gv {
  constructor(t) {
  ...
  getBlockMapFiles(t, r, n, i = null) {
    ...
    return [(0, si.newUrlFromBase)(`${t.pathname.replace(new RegExp(mv(n), "g"), r)}.blockmap`, i ? new pv.URL(i) : t), o];
  }
...
const nl = de, so = Ke, lo = ue;
class vv extends lo.Provider {
  constructor(t, r, n) {
  ...
  async getLatestVersion() {
    ...
    for (let n = 0; ; n++)
      try {
        ...
        if (i instanceof nl.HttpError && i.statusCode === 404)
          throw (0, nl.newError)(`Cannot find channel "${t}" update info: ${i.stack || i.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
...
fn.GenericProvider = vv;
var Ci = {}, bi = {};
Object.defineProperty(bi, "__esModule", { value: !0 });
bi.BitbucketProvider = void 0;
const il = de, co = Ke, uo = ue;
class _v extends uo.Provider {
  constructor(t, r, n) {
    super({
      ...n,
  ...
  async getLatestVersion() {
    const t = new il.CancellationToken(), r = (0, co.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, co.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
bi.BitbucketProvider = _v;
var Tt = {};
Object.defineProperty(Tt, "__esModule", { value: !0 });
Tt.GitHubProvider = Tt.BaseGitHubProvider = void 0;
Tt.computeReleaseNotes = Yu;
const it = de, Ut = Bu, Av = Ct, ir = Ke, Uo = ue, fo = /\/tag\/([^/]+)$/;
class Vu extends Uo.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (A === null)
          ...
          for (const S of l.getElements("entry")) {
            ...
            if (T === null)
              continue;
            const D = T[1], x = ((n = Ut.prerelease(D)) === null || n === void 0 ? void 0 : n[0]) || null, te = !A || ["alpha", "beta"].includes(A), le = x !== null && !["alpha", "beta"].includes(String(x));
...
${s}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const E = (0, Uo.parseUpdateInfo)(f, h, g);
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, ir.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new Av.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
const be = de, ho = Ct, Sv = Gu, Bn = Ke, po = ue;
class Cv extends po.Provider {
  ...
  async getLatestVersion() {
    const t = new be.CancellationToken(), r = (0, Bn.newUrlFromBase)(`projects/${this.options.projectId}/releases/permalink/latest`, this.baseApiUrl);
    let n;
    try {
      ...
      throw (0, be.newError)(`Unable to find latest release on GitLab (${r}): ${h.stack || h.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
    const i = n.tag_name;
    let o = null, a = "", s = null;
    const l = async (h) => {
  ...
  async findBlockMapUrlsFromAssets(t, r, n) {
    ...
    if (s) {
      const l = n.replace(new RegExp(Sv(r), "g"), t);
...
Ri.GitLabProvider = Cv;
var $i = {};
Object.defineProperty($i, "__esModule", { value: !0 });
$i.KeygenProvider = void 0;
const al = de, mo = Ke, go = ue;
class bv extends go.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
  ...
  async getLatestVersion() {
    const t = new al.CancellationToken(), r = (0, mo.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, mo.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
const Kt = de, Rv = _e, $v = oe, sl = Ct, ll = Ke, Pv = Tt, Iv = ue;
class Ov extends Pv.BaseGitHubProvider {
  constructor(t, r, n, i) {
  ...
  async getLatestVersion() {
    const t = new Kt.CancellationToken(), r = (0, ll.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((s) => s.name === r);
    if (i == null)
  ...
  resolveFiles(t) {
    return (0, Iv.getFileList)(t).map((r) => {
...
Pi.PrivateGitHubProvider = Ov;
Object.defineProperty(Ci, "__esModule", { value: !0 });
Ci.isUrlProbablySupportMultiRangeRequests = zu;
Ci.createClient = Uv;
const jn = de, Dv = bi, cl = fn, Nv = Tt, Fv = Ri, xv = $i, Lv = Pi;
function zu(e) {
...
function Uv(e, t, r) {
  ...
  switch (n) {
    case "github": {
      ...
      return o == null ? new Nv.GitHubProvider(i, t, r) : new Lv.PrivateGitHubProvider(i, t, o, r);
    }
    case "bitbucket":
      return new Dv.BitbucketProvider(e, t, r);
    case "gitlab":
      return new Fv.GitLabProvider(e, t, r);
    case "keygen":
...
Vt.computeOperations = kv;
var kt;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(kt || (Vt.OperationKind = kt = {}));
function kv(e, t, r) {
  const n = fl(e.files), i = fl(t.files);
  let o = null;
  ...
  const c = i.get(l);
  let f = 0;
  const { checksumToOffset: h, checksumToOldSize: g } = Bv(n.get(l), d.offset, r);
  let w = a.offset;
  for (let E = 0; E < c.checksums.length; w += c.sizes[E], E++) {
    ...
    T != null && g.get(S) !== A && (r.warn(`Checksum ("${S}") matches, but size differs (old: ${g.get(S)}, new: ${A})`), T = void 0), T === void 0 ? (f++, o != null && o.kind === kt.DOWNLOAD && o.end === w ? o.end += A : (o = {
      ...
      // oldBlocks: null,
    }, ul(o, s, S, E))) : o != null && o.kind === kt.COPY && o.end === T ? o.end += A : (o = {
      kind: kt.COPY,
      start: T,
      end: T + A
      // oldBlocks: [checksum]
...
wr.copyData = Xu;
const Hn = de, jv = St, Hv = Zr, qv = Vt, dl = Buffer.from(`\r
\r
`);
var dt;
(function(e) {
...
Oi.executeTasksUsingMultipleRangeRequests = Wv;
Oi.checkIsRangesSupported = Mo;
const ko = de, hl = wr, pl = Vt;
...
function Vv(e, t, r, n, i) {
  ...
  for (let h = t.start; h < t.end; h++) {
    const g = t.tasks[h];
    g.kind === pl.OperationKind.DOWNLOAD && (o += `${g.start}-${g.end - 1}, `, l.set(a, h), a++, d.push(g.end - g.start), s += g.end - g.start);
  }
  if (a <= 1) {
    const h = (g) => {
      if (g >= t.end) {
  ...
  const f = e.httpExecutor.createRequest(c, (h) => {
    if (!Mo(h, i))
      return;
    const g = (0, ko.safeGetHeader)(h, "content-type"), w = /^multipart\/.+?\s*;\s*boundary=(?:"([^"]+)"|([^\s";]+))\s*$/i.exec(g);
    if (w == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${g}"`));
      return;
    }
    const E = new hl.DataSplitter(r, t, l, w[1] || w[2], d, n, s, e.options.onProgress);
...
Di.ProgressDifferentialDownloadCallbackTransform = zv;
Object.defineProperty(dn, "__esModule", { value: !0 });
dn.DifferentialDownloader = void 0;
const Pr = de, yo = bt, Xv = St, Kv = wr, Jv = Ct, qn = Vt, ml = Oi, Qv = Di;
class Zv {
  ...
  doDownload(t, r) {
    ...
    return n.info(`Full: ${gl(s)}, To download: ${gl(o)} (${Math.round(o / (s / 100))}%)`), this.downloadFile(i);
  }
  downloadFile(t) {
  ...
  async doDownloadFile(t, r) {
    ...
    const o = (0, Xv.createWriteStream)(this.options.newFile, { fd: i });
    await new Promise((a, s) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        d = new Qv.ProgressDifferentialDownloadCallbackTransform(D, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      if (this.options.isUseMultipleRangeRequest) {
        g = (0, ml.executeTasksUsingMultipleRangeRequests)(this, t, h, n, s), g(0);
        return;
      }
      let w = 0, E = null;
      ...
      A.redirect = "manual", g = (S) => {
        ...
        if (x.kind === qn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, Kv.copyData)(x, h, n, s, () => g(S));
          return;
        }
        const te = `bytes=${x.start}-${x.end - 1}`;
        A.headers.range = te, (D = (T = this.logger) === null || T === void 0 ? void 0 : T.debug) === null || D === void 0 || D.call(T, `download range: ${te}`), d && d.beginRangeDownload();
        ...
        le.on("redirect", (V, Ue, y) => {
          this.logger.info(`Redirect to ${e_(y)}`), E = y, (0, Pr.configureRequestUrl)(new Jv.URL(E), A), le.followRedirect();
...
const t_ = dn;
class r_ extends t_.DifferentialDownloader {
  download(t, r) {
    return this.doDownload(t, r);
  }
}
Ii.GenericDifferentialDownloader = r_;
var Rt = {};
(function(e) {
...
const Re = de, n_ = en, i_ = ci, o_ = jl, Ge = bt, a_ = _e, Eo = Ei, We = oe, xt = Bu, yl = un, s_ = Si, El = ju, l_ = fn, wo = Ci, vo = ql, c_ = Ii, Jt = Rt;
class ga extends o_.EventEmitter {
  /**
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new s_.ElectronAppAdapter(), this.httpExecutor = new El.ElectronHttpExecutor((o, a) => this.emit("login", o, a))) : (this.app = r, this.httpExecutor = null);
    ...
    this.currentVersion = i, this.allowPrerelease = u_(i), t != null && (this.setFeedURL(t), typeof t != "string" && t.requestHeaders && (this.requestHeaders = t.requestHeaders));
  }
  //noinspection JSMethodCanBeStatic,JSUnusedGlobalSymbols
  getFeedURL() {
  ...
  setFeedURL(t) {
    ...
    let n;
    typeof t == "string" ? n = new l_.GenericProvider({ provider: "generic", url: t }, this, {
      ...r,
  ...
  checkForUpdatesAndNotify(t) {
    return this.checkForUpdates().then((r) => r != null && r.downloadPromise ? (r.downloadPromise.then(() => {
      const n = ga.formatDownloadNotification(r.updateInfo.version, this.app.name, t);
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, a_.load)(await (0, Ge.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = Re.UUID.v5((0, n_.randomBytes)(4096), Re.UUID.OID);
  ...
  async getOrCreateDownloadHelper() {
    ...
    if (t == null) {
      ...
      n.debug != null && n.debug(`updater cache dir: ${i}`), t = new yl.DownloadedUpdateHelper(i), this.downloadedUpdateHelper = t;
    }
    return t;
  }
  async executeDownload(t) {
    ...
    })), S = await (0, yl.createTempUpdateFile)(`temp-${c}`, d, w);
    try {
      await t.task(S, n, h, A), await (0, Re.retry)(() => (0, Ge.rename)(S, f), {
        retries: 60,
        interval: 500,
        shouldRetry: (T) => T instanceof Error && /^EBUSY:/.test(T.message) ? !0 : (w.warn(`Cannot rename temp file to final file: ${T.message || T.stack}`), !1)
      });
    } catch (T) {
      throw await A(), T instanceof Re.CancellationError && (w.info("cancelled"), this.emit("update-cancelled", i)), T;
    }
  ...
  async differentialDownloadInstaller(t, r, n, i, o) {
    try {
      ...
      return g == null && (g = await l(s[0])), await new c_.GenericDifferentialDownloader(t.info, this.httpExecutor, d).download(g, h), !1;
    } catch (a) {
...
const wl = li, f_ = wt;
class d_ extends f_.AppUpdater {
  constructor(t, r) {
  ...
  async spawnLog(t, r = [], n = void 0, i = "ignore") {
    return this._logger.info(`Executing: ${t} with args: ${r}`), new Promise((o, a) => {
      try {
        const s = { stdio: i, env: n, detached: !0 }, l = (0, wl.spawn)(t, r, s);
        l.on("error", (d) => {
          a(d);
...
const Qt = bt, h_ = dn, p_ = ql;
class m_ extends h_.DifferentialDownloader {
  async download() {
...
hn.FileWithEmbeddedBlockMapDifferentialDownloader = m_;
function Ju(e) {
  return JSON.parse((0, p_.inflateRawSync)(e).toString());
}
async function g_(e) {
...
const vl = de, _l = li, y_ = bt, E_ = St, Ir = oe, w_ = Wt, v_ = hn, __ = ue, Al = Rt;
class A_ extends w_.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  isUpdaterActive() {
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, __.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "AppImage", ["rpm", "deb", "pacman"]);
    return this.executeDownload({
      ...
      task: async (i, o) => {
        ...
        (t.disableDifferentialDownload || await this.downloadDifferential(n, a, i, r, t)) && await this.httpExecutor.download(n.url, i, o), await (0, y_.chmod)(i, 493);
      }
    });
  }
  async downloadDifferential(t, r, n, i, o) {
    try {
      ...
      return this.listenerCount(Al.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(Al.DOWNLOAD_PROGRESS, s)), await new v_.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, a).download(), !1;
    } catch (a) {
  ...
  doInstall(t) {
    ...
    if (o == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    Ir.basename(o) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = Ir.join(Ir.dirname(r), Ir.basename(o)), (0, _l.execFileSync)("mv", ["-f", o, n]), n !== r && this.emit("appimage-filename-updated", n);
    const a = {
      ...process.env,
      APPIMAGE_SILENT_INSTALL: "true"
    };
    return t.isForceRunAfter ? this.spawnLog(n, [], a) : (a.APPIMAGE_EXIT_AFTER_INSTALL = "true", (0, _l.execFileSync)(n, [], { env: a })), !0;
  }
}
Yr.AppImageUpdater = A_;
var zr = {}, vr = {};
Object.defineProperty(vr, "__esModule", { value: !0 });
vr.LinuxUpdater = void 0;
const T_ = Wt;
class S_ extends T_.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /**
...
const C_ = ue, Tl = Rt, b_ = vr;
class ya extends b_.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, C_.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "deb", ["AppImage", "rpm", "pacman"]);
    return this.executeDownload({
      fileExtension: "deb",
      fileInfo: n,
      downloadUpdateOptions: t,
...
class Ea extends $_.LinuxUpdater {
  ...
  doInstall(t) {
    ...
    if (r == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    try {
      Ea.installWithCommandRunner(r, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (n) {
...
const Cl = Rt, P_ = ue, I_ = vr;
class wa extends I_.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, P_.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "rpm", ["AppImage", "deb", "pacman"]);
    return this.executeDownload({
      fileExtension: "rpm",
      fileInfo: n,
      downloadUpdateOptions: t,
  ...
  doInstall(t) {
    ...
    try {
      wa.installWithCommandRunner(i, r, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (o) {
      return this.dispatchError(o), !1;
    }
    return t.isForceRunAfter && this.app.relaunch(), !0;
...
const bl = de, _o = bt, O_ = St, Rl = oe, D_ = yd, N_ = wt, F_ = ue, $l = li, Pl = en;
class x_ extends N_.AppUpdater {
  constructor(t, r) {
  ...
  async doDownloadUpdate(t) {
    ...
    let o = !1;
    try {
      this.debug("Checking for macOS Rosetta environment"), o = (0, $l.execFileSync)("sysctl", [i], { encoding: "utf8" }).includes(`${i}: 1`), n.info(`Checked for macOS Rosetta environment (isRosetta=${o})`);
    } catch (f) {
    ...
    try {
      ...
      const h = (0, $l.execFileSync)("uname", ["-a"], { encoding: "utf8" }).includes("ARM");
    ...
    const l = (0, F_.findFile)(r, "zip", ["pkg", "dmg"]);
    if (l == null)
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (f, h) => {
        const g = Rl.join(this.downloadedUpdateHelper.cacheDir, c), w = () => (0, _o.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let E = !0;
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const f = (0, Pl.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), h = Buffer.from(`autoupdater:${f}`, "ascii"), g = `/${(0, Pl.randomBytes)(64).toString("hex")}.zip`;
...
va.verifySignature = U_;
const Il = de, Qu = li, L_ = ci, Ol = oe;
function Zu(e, t) {
  ...
  return new Promise((n, i) => {
    ...
    r.info(`Verifying signature ${o}`), (0, Qu.execFile)(...Zu(`"Get-AuthenticodeSignature -LiteralPath '${o}' | ConvertTo-Json -Compress"`, 20 * 1e3), (a, s, l) => {
      ...
      try {
        ...
        if (c.Status === 0) {
          try {
            const w = Ol.normalize(c.Path), E = Ol.normalize(t);
          ...
          const h = (0, Il.parseDn)(c.SignerCertificate.Subject);
          let g = !1;
          for (const w of e) {
            const E = (0, Il.parseDn)(w);
...
const Gn = de, Dl = oe, B_ = Wt, j_ = hn, Nl = Rt, H_ = ue, q_ = bt, G_ = va, Fl = Ct;
class W_ extends B_.BaseUpdater {
  constructor(t, r) {
    super(t, r), this._verifyUpdateCodeSignature = (n, i) => (0, G_.verifySignature)(n, i, this._logger);
  }
  /**
    ...
    return this.executeDownload({
      ...
      task: async (i, o, a, s) => {
        ...
        if (d && await this.differentialDownloadWebPackage(t, l, a, r))
          try {
            await this.httpExecutor.download(new Fl.URL(l.path), a, {
  ...
  doInstall(t) {
    ...
    const o = () => {
      this.spawnLog(Dl.join(process.resourcesPath, "elevate.exe"), [r].concat(n)).catch((a) => this.dispatchError(a));
    };
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const o = {
        newUrl: new Fl.URL(r.path),
        oldFile: Dl.join(this.downloadedUpdateHelper.cacheDir, Gn.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(Nl.DOWNLOAD_PROGRESS) > 0 && (o.onProgress = (a) => this.emit(Nl.DOWNLOAD_PROGRESS, a)), await new j_.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, o).download();
    } catch (o) {
...
const Y_ = z.dirname(Ml(import.meta.url));
...
const xl = "velostudio";
process.defaultApp && process.argv.length >= 2 ? me.setAsDefaultProtocolClient(xl, process.execPath, [z.resolve(process.argv[1])]) : me.setAsDefaultProtocolClient(xl);
let ar = null;
function ef(e) {
...
process.env.APP_ROOT = z.join(Y_, "..");
const X_ = process.env.VITE_DEV_SERVER_URL, EA = z.join(process.env.APP_ROOT, "dist-electron"), tf = z.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = X_ ? z.join(process.env.APP_ROOT, "public") : tf;
let we = null, ee = null, Nr = null, lr = null, rf = "", nf = !1;
const of = af("openscreen.png"), K_ = af("rec-button.png");
function _a() {
  we = wd();
}
function Ll() {
...
function To(e = !1) {
  if (!lr) return;
  const t = e ? K_ : of, r = e ? `Recording: ${rf}` : "Velo Studio", n = e ? [
    {
  ...
  ] : [
    {
      ...
      click: () => {
        ...
        we && !we.isDestroyed() ? we.isMinimized() && we.restore() : _a();
      }
    },
    {
      label: "Quit",
  ...
  lr.setImage(t), lr.setToolTip(r), lr.setContextMenu(hd.buildFromTemplate(n));
}
function J_() {
  we && (we.close(), we = null), we = vd();
}
function Q_() {
  return Nr = _d(), Nr.on("closed", () => {
    Nr = null;
  }), Nr;
}
...
me.whenReady().then(async () => {
  if (Ul.handle("velo-asset", (t) => {
    ...
    const o = z.join(i, n);
    return console.log("[velo-asset protocol] Resolving:", t.url, "->", o), fd.fetch(pd(o).href);
  ...
  e.on("hud-overlay-close", () => {
    ...
    console.log("[Auth] auth-ready received, switching to HUD overlay"), nf = !0, ee && !ee.isDestroyed() && (ee.close(), ee = null), setTimeout(() => {
      (!we || we.isDestroyed()) && _a(), To();
    }, 300);
    ...
    () => Nr,
    (t, r) => {
      rf = r, lr || Ll(), To(t), t || we && we.restore();
    }
  ), ee = Ad(), ee.on("closed", () => {
    ee = null;
  }), ar && setTimeout(() => {
