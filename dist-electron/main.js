import { ipcMain, screen, BrowserWindow, desktopCapturer, shell, app, dialog, protocol, nativeImage, net, Tray, Menu } from "electron";
...
function registerIpcHandlers(createEditorWindow2, createSourceSelectorWindow2, getMainWindow, getSourceSelectorWindow, onRecordingStateChange) {
  ...
  ipcMain.handle("record-cursor-click", (_, button) => {
  ...
  ipcMain.handle("save-cursor-data", async (_, videoPath, cursorData) => {
    try {
